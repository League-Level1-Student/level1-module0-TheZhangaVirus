	...
	private void startQuiz() {
		...
		String guess = JOptionPane.showInputDialog("who is this?");
			if(guess.equalsIgnoreCase("Arnold")) {
				...
				JOptionPane.showMessageDialog(null, "wrong, its arnold you nerd");
			}
		...
		if(guess2.equalsIgnoreCase("Leonardo")) {
				...
				JOptionPane.showMessageDialog(null, "wrong, its leonardo you nerd");
			}
		...
		if(guess3.equalsIgnoreCase("Morgan")) {
				...
				JOptionPane.showMessageDialog(null, "wrong, its morgan you nerd");
			}
		...
		if(guess4.equalsIgnoreCase("Jack")) {
				...
				JOptionPane.showMessageDialog(null, "wrong, its jack you nerd");
			}
